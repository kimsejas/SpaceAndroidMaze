...
//        g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
	...
	private void drawArms(MazePanel panel, final int length, final int width) {
        ...
        panel.setColor(ColorTheme.getColor(ColorTheme.MazeColors.COMPASSROSE_MAIN_COLOR).toArgb());
        // draw each arm
	...
	private void drawBackground(MazePanel panel) {
		...
		panel.setColor(ColorTheme.getColor(ColorTheme.MazeColors.COMPASSROSE_BACKGROUND).toArgb());
...
//        g2.drawPolygon(x, y, 3);
	...
	private void drawBorderCircle(MazePanel panel, int width) {
		...
		// draw both arcs
        panel.setColor(ColorTheme.getColor(ColorTheme.MazeColors.COMPASSROSE_CIRCLE_SHADE).toArgb());
        panel.addArc(x, y, w, w, 45, 180);
        panel.setColor(ColorTheme.getColor(ColorTheme.MazeColors.COMPASSROSE_CIRCLE_HIGHLIGHT).toArgb());
